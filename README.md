...
- Ganti ApiKey OpenAI pada file [key.json](https://github.com/nazmugit/gpt/blob/844f41c362250bed10857443c013cbb454807e87/key.json#L2)
...
```bash
git clone https://github.com/nazmugit/gpt
cd gpt
npm install
node index.js
```
...
## License
[MIT License](https://github.com/nazmugit/gpt/blob/main/LICENSE)

Copyright (c) 2022 Nazmu
